  ...
  return (
    <div className="shadow-xl">
      <div className="w-full xl:flex xl:max-w-full">
        ...
        <div className="flex flex-col justify-between rounded-b bg-white p-4 leading-normal xl:rounded-b-none xl:rounded-r">
          <div className="mb-8">
