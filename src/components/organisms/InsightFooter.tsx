...
const InsightFooter = (): JSX.Element => (
    ...
    <div className="container mx-auto p-6">
      <div className="lg:flex">
        ...
        <div className="mt-6 lg:mt-0 lg:flex-1">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
            <div>
              <InsightTypography level="h4">About</InsightTypography>
              <a
                href="#"
            ...
            <div>
              <InsightTypography level="h4">Products</InsightTypography>
              <a
                href="#"
                className="mt-2 block text-sm text-gray-600 hover:underline dark:text-gray-400"
              >
            ...
            <div>
              <InsightTypography level="h4">Contact</InsightTypography>
      ...
      <div>
        <p className="text-center text-gray-500 dark:text-gray-400">
          © Insight 2022 - All rights reserved
        </p>
      </div>
    </div>
  </footer>
